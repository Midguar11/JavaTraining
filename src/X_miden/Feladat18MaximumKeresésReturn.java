...
public class Feladat18MaximumKeresésReturn {
    public static void main(String[] args) {
        ...
        melyikNagyobb(A, B, C);
        System.out.println(melyikNagyobb(A,B,C));

    }

    private static String melyikNagyobb(int A, int B, int C)

    {
        String back ="";
        if (A > B && A > C) {
           back = ("A három általad megadott számból " + A + " - " + B + "- " + C + "\n A nagyobb érték a A:\t" + A);
        } else if (B > A && B > C) {
